...
This repo uses [Changesets](https://changesets.dev/) for changelog and version bumps only — there's no `npm publish` step, since cortex-forge distributes via `npx skills add itsmistermoon/cortex-forge`, not the npm registry.
