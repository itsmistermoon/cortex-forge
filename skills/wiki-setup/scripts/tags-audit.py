#!/usr/bin/env python3
"""
Tag-usage audit, invoked by `wiki-setup`'s maintenance menu (option 10).
...
Usage: python3 scripts/tags-audit.py <vault-path> [--write-snapshot]
"""
import re
import sys
...
def main():
    ...
    lines = [
        "# Tags audit",
        "",
        "[//]: # \"Generado por wiki-setup's scripts/tags-audit.py (maintenance menu option 10). Re-run manually.\"",
        "",
        "## Resumen",
        "",
        "| Métrica | Valor |",
