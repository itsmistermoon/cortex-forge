...
_check_synced "references" "LOCALE-RESOLUTION.md" wiki-ingest hot-handoff wiki-imprint
_check_synced "references" "VAULT-RESOLUTION.md" wiki-ingest hot-handoff wiki-imprint wiki-prune wiki-recall
