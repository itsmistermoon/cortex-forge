...
Created when switching branches via `/tree` with an LLM generated summary of the left branch up to the common ancestor.
...
- `appendSessionInfo(name)` — Set display name
