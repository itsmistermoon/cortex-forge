...
![](https://raw.githubusercontent.com/tinyhumansai/openhuman/main/gitbooks/.gitbook/assets/image%20(1).png)
...
\| \[Retrieval & Recall\](retrieval.md) \| The \`memory\_tree\` tool modes the agent uses to read memory back. \|
