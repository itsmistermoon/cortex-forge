#!/usr/bin/env python3
"""
Tag-usage audit, invoked by `antu-setup`'s maintenance menu (option 10).
...
def main():
    ...
    lines = [
        "# Tags audit",
        "",
        "[//]: # \"Generado por antu-setup's scripts/tags-audit.py (maintenance menu option 10). Re-run manually.\"",
        "",
        "## Resumen",
        "",
        "| Métrica | Valor |",
