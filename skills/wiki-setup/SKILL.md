...
4. **Verify global skills are installed** — check each of the 6 skills (`hot-handoff`, `wiki-setup`, `wiki-recall`, `wiki-ingest`, `wiki-imprint`, `wiki-prune`) individually for presence under `~/.agents/skills/` — do not assume presence just because this skill is running.
