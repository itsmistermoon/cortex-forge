...
## [​](https://agentskills.io/skill-creation/best-practices\#start-from-real-expertise)  Start from real expertise
...
### [​](https://agentskills.io/skill-creation/best-practices\#extract-from-a-hands-on-task)  Extract from a hands-on task
...
### [​](https://agentskills.io/skill-creation/best-practices\#synthesize-from-existing-project-artifacts)  Synthesize from existing project artifacts
...
## [​](https://agentskills.io/skill-creation/best-practices\#refine-with-real-execution)  Refine with real execution
...
## [​](https://agentskills.io/skill-creation/best-practices\#spending-context-wisely)  Spending context wisely
...
### [​](https://agentskills.io/skill-creation/best-practices\#add-what-the-agent-lacks-omit-what-it-knows)  Add what the agent lacks, omit what it knows
...
### [​](https://agentskills.io/skill-creation/best-practices\#design-coherent-units)  Design coherent units
...
### [​](https://agentskills.io/skill-creation/best-practices\#aim-for-moderate-detail)  Aim for moderate detail
...
### [​](https://agentskills.io/skill-creation/best-practices\#structure-large-skills-with-progressive-disclosure)  Structure large skills with progressive disclosure
...
## [​](https://agentskills.io/skill-creation/best-practices\#calibrating-control)  Calibrating control
...
### [​](https://agentskills.io/skill-creation/best-practices\#match-specificity-to-fragility)  Match specificity to fragility
...
### [​](https://agentskills.io/skill-creation/best-practices\#provide-defaults-not-menus)  Provide defaults, not menus
...
### [​](https://agentskills.io/skill-creation/best-practices\#favor-procedures-over-declarations)  Favor procedures over declarations
...
This doesn’t mean skills can’t include specific details — output format templates (see [Templates for output format](https://agentskills.io/skill-creation/best-practices#templates-for-output-format)), constraints like “never output PII,” and tool-specific instructions are all valuable. The point is that the _approach_ should generalize even when individual details are specific.

## [​](https://agentskills.io/skill-creation/best-practices\#patterns-for-effective-instructions)  Patterns for effective instructions
...
### [​](https://agentskills.io/skill-creation/best-practices\#gotchas-sections)  Gotchas sections
...
### [​](https://agentskills.io/skill-creation/best-practices\#templates-for-output-format)  Templates for output format
...
### [​](https://agentskills.io/skill-creation/best-practices\#checklists-for-multi-step-workflows)  Checklists for multi-step workflows
...
### [​](https://agentskills.io/skill-creation/best-practices\#validation-loops)  Validation loops
...
### [​](https://agentskills.io/skill-creation/best-practices\#plan-validate-execute)  Plan-validate-execute
...
### [​](https://agentskills.io/skill-creation/best-practices\#bundling-reusable-scripts)  Bundling reusable scripts
...
## [​](https://agentskills.io/skill-creation/best-practices\#next-steps)  Next steps
...
[Quickstart](https://agentskills.io/skill-creation/quickstart) [Optimizing descriptions](https://agentskills.io/skill-creation/optimizing-descriptions)
