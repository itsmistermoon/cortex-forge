...
- [x] Imprint candidate flagging — `hot-handoff` writes `#### Imprint candidate` to History when warranted; `AGENTS.md` protocol surfaces it and proposes `/wiki-imprint` at next session start
